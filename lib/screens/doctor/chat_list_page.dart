...
import 'package:doctorappointment/models/patient.dart';
...
class _DoctorChatlistPageState extends State<DoctorChatlistPage> {
  ...
  final DatabaseReference _patientsDatabase = FirebaseDatabase.instance.ref().child('Pacientes');
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(title: Text('Conversa com '),),
      body: _isLoading ? Center(child: CircularProgressIndicator())
          : _chatList.isEmpty
          ? Center(child: Text('Nenhuma conversa disponivel'))
          : ListView.builder(
          ...
          itemBuilder: (context, index){
            ...
            return Card(
              ...
              child: ListTile(
                title: Text('Conversa com ${patient.firstName} ${patient.lastName}'),
                onTap: (){
